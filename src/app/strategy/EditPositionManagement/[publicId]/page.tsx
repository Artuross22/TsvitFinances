...
const PositionManagement: React.FC<Props> = ({ params }) => {
  const [positionManagement, setPositionManagement] = useState<EditPositionManagement | null>(null);
  ...
  if (!positionManagement) {
    return <div className="text-center text-red-500">Failed to load position data</div>;
  }
