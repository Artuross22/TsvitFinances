...
export const AddStockMetrics = ({ params }: Props) => {
  ...
  const [stockMetrics, setStockMetrics] = useState<
    Partial<FinanceDataStockMetrics>
  >({});
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="form-group">
              ...
              <input
                ...
                name="peRatio"
                value={
                  stockMetrics.peRatio !== undefined ? stockMetrics.peRatio : ""
                }
            ...
            <div className="form-group">
              <label
                htmlFor="operatingCashFlowPerShare"
                className="block text-sm font-medium text-gray-700 mb-1"
              >
              ...
              <input
                ...
                value={
                  stockMetrics.operatingCashFlowPerShare !== undefined
                    ? stockMetrics.operatingCashFlowPerShare
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="form-group">
              ...
              <input
                ...
                name="pbRatio"
                value={
                  stockMetrics.pbRatio !== undefined ? stockMetrics.pbRatio : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
                required
            ...
            <div className="form-group">
              ...
              <input
                ...
                name="dividendYield"
                value={
                  stockMetrics.dividendYield !== undefined
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={
                  stockMetrics.debtToEquityRatio !== undefined
                    ? stockMetrics.debtToEquityRatio
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="form-group">
              ...
              <input
                ...
                name="psRatio"
                value={
                  stockMetrics.psRatio !== undefined ? stockMetrics.psRatio : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
                required
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={
                  stockMetrics.freeCashFlowPerShare !== undefined
                    ? stockMetrics.freeCashFlowPerShare
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={
                  stockMetrics.netProfitMargin !== undefined
                    ? stockMetrics.netProfitMargin
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="form-group">
              ...
              <input
                ...
                name="revenueGrowth"
                value={
                  stockMetrics.revenueGrowth !== undefined
                    ? stockMetrics.revenueGrowth
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="form-group">
              ...
              <input
                ...
                name="debtRatio"
                value={
                  stockMetrics.debtRatio !== undefined
                    ? stockMetrics.debtRatio
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="form-group">
              ...
              <input
                ...
                name="freeCashFlow"
                value={
                  stockMetrics.freeCashFlow !== undefined
            ...
            <div className="form-group">
              ...
              <input
                ...
                name="netIncome"
                value={
                  stockMetrics.netIncome !== undefined
                    ? stockMetrics.netIncome
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={
                  stockMetrics.sharesOutstanding !== undefined
                    ? stockMetrics.sharesOutstanding
                    : ""
                }
                onChange={handleChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md"
