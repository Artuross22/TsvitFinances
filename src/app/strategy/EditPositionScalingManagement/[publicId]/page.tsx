...
const PositionScalingManager: React.FC<Props> = ({ params }) => {
  ...
  const [positionManagement, setPositionManagement] =
    useState<GetPositionScaling | null>(null);
  ...
  const updatePositionScaling = (
    index: number,
    updates: Partial<PositionScalings>,
  ) => {
  ...
  const removePositionScaling = (index: number) => {
    ...
    const updatedScalings = positionManagement.positionScalings.filter(
      (_, i) => i !== index,
    );
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Configure your position scaling targets for optimal risk
                management
              </p>
            </div>
            ...
            {emptyState ? (
              <div className="text-center py-16 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                ...
                <p className="mt-4 text-gray-500">
                  No positions added yet. Click one of the buttons below to add
                  a position.
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  {positionManagement?.positionScalings
                    ?.filter(
                      (scaling) => scaling.positionType === PositionType.Short,
                    )
                    .map((scaling, index) => (
                      <div
                ...
                <div className="space-y-3">
                  ...
                  {positionManagement?.positionScalings
                    ?.filter(
                      (scaling) => scaling.positionType === PositionType.Long,
                    )
                    .map((scaling, index) => (
                      <div
                        key={scaling.publicId}
