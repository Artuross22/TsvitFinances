  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
        <div className="mb-6">
          <label className="block text-gray-700 font-medium mb-2">Upload Charts</label>
          <input
            ref={fileInputRef}
            type="file"
        ...
        <button
          ...
          className={`w-full px-4 py-2 rounded-md text-white transition-colors ${
            !charts.length || isSubmitting ? "bg-gray-400 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-600"
          }`}
        >
