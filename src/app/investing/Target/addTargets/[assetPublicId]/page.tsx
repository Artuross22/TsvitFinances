...
export default function AddTarget({ params }: Props) {
  ...
  const addBuyLevel = (): void => {
    setTargets((prev) => ({
      ...
      BuyLevels: [
        ...prev.BuyLevels,
        { description: "", averageLevel: null } as BuyLevels,
      ],
    }));
  };
  ...
  const addSalesLevel = (): void => {
    setTargets((prev) => ({
      ...
      SalesLevels: [
        ...prev.SalesLevels,
        { description: "", averageLevel: null } as SalesLevels,
      ],
    }));
  };
  ...
  const updateBuyLevel = (
    index: number,
    field: keyof BuyLevels,
    value: string | number,
  ): void => {
    setTargets((prev) => ({
      ...prev,
  ...
  const updateSalesLevel = (
    index: number,
    field: keyof SalesLevels,
    value: string | number,
  ): void => {
    setTargets((prev) => ({
      ...prev,
            ...
            {targets.BuyLevels.map((level, index) => (
              <div key={index} className="grid grid-cols-4 gap-4">
                <input
                  ...
                  onChange={(e) =>
                    updateBuyLevel(index, "description", e.target.value)
                  }
                />
                <input
                  type="number"
                  ...
                  value={level.level || ""}
                  onChange={(e) =>
                    updateBuyLevel(index, "level", Number(e.target.value))
                  }
                />
                <input
                  type="number"
            ...
            {targets.SalesLevels.map((level, index) => (
              <div key={index} className="grid grid-cols-4 gap-4">
                <input
                  ...
                  value={level.description || ""}
                  onChange={(e) =>
                    updateSalesLevel(index, "description", e.target.value)
                  }
                />
                <input
                  type="number"
                  ...
                  value={level.level || ""}
                  onChange={(e) =>
                    updateSalesLevel(index, "level", Number(e.target.value))
                  }
                />
                <input
                  type="number"
