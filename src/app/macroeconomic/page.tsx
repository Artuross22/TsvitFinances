...
export default function MacroeconomicView() {
  const [macroeconomicData, setMacroeconomicData] =
    useState<ViewMacroeconomic>();
  const [loading, setLoading] = useState(true);
  const [economicType, setEconomicType] = useState<EconomicType>(
    EconomicType.Positive,
  );
        ...
        <div className="grid gap-4">
          <div className="border rounded-lg p-4 shadow-sm">
            <h2 className="text-xl font-semibold mb-2">
              {macroeconomicData!.title}
            </h2>
            <p className="text-gray-600 mb-2">
              {macroeconomicData!.description}
            </p>
            ...
            <div className="flex justify-end">
              <Link
                href={`/macroeconomic/event/add/${macroeconomicData!.publicId}`}
              >
            ...
            {macroeconomicData!.macroeconomicEvents &&
              macroeconomicData!.macroeconomicEvents.length > 0 && (
                <div className="mt-4">
                    ...
                    {macroeconomicData!.macroeconomicEvents.map((event) => (
                      ...
                      >
                        ...
                        <div className="flex justify-between text-sm text-gray-500 mt-2">
                          ...
                          <span>
                            {new Date(event.createAt).toLocaleDateString()}
                          </span>
                        </div>
                      </div>
                    ))}
